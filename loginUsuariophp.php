...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result->num_rows > 0) {
        ...
        if ($contraseña === $row['Contraseña']) {
            ...
            echo "<script>alert('Contraseña incorrecta.'); window.location.href='loginUsuario.html';</script>";
        }
    } else {
        echo "<script>alert('No se encontro usuario.'); window.location.href='loginUsuario.html';</script>";
    }
